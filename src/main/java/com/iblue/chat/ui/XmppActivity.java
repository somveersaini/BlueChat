...
import com.iblue.chat.services.AvatarService;
import com.iblue.chat.services.XmppConnectionService;
import com.iblue.chat.services.XmppConnectionService.XmppConnectionBinder;
import com.iblue.chat.ui.widget.Switch;
            ...
            nfcAdapter.setNdefPushMessageCallback(new NfcAdapter.CreateNdefMessageCallback() {
                ...
                public NdefMessage createNdefMessage(NfcEvent nfcEvent) {
                    return new NdefMessage(new NdefRecord[]{
                            ...
                            NdefRecord.createApplicationRecord("com.iblue.conversations")
                    });
                }
            }, this);
        }
