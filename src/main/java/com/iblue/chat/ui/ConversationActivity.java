...
import com.iblue.chat.crypto.axolotl.XmppAxolotlSession;
...
import com.iblue.chat.services.XmppConnectionService.OnAccountUpdate;
import com.iblue.chat.services.XmppConnectionService.OnConversationUpdate;
import com.iblue.chat.services.XmppConnectionService.OnRosterUpdate;
import com.iblue.chat.ui.adapter.ConversationAdapter;
...
public class ConversationActivity extends XmppActivity
    ...
    public static final String ACTION_DOWNLOAD = "com.iblue.chat.action.DOWNLOAD";
    ...
    public void showConversationsOverview() {
        if (mContentView instanceof LinearLayout) {
            LinearLayout pane = (LinearLayout) mContentView;

            View view = findViewById(R.id.selected_conversation);
            //view.animate().alpha(0.0f).setDuration(500);
            view.setVisibility(View.GONE);
            pane.setVisibility(View.VISIBLE);
           // pane.animate().alpha(1.0f).setDuration(1000);
            load();
        }
    }
    ...
    public void hideConversationsOverview() {
        if (mContentView instanceof LinearLayout) {
            View view = findViewById(R.id.selected_conversation);
           // mContentView.animate().alpha(0.0f).setDuration(500);
    ...
    protected void onCreate(final Bundle savedInstanceState) {
        ...
        mContentView = findViewById(R.id.pane);
    ...
    private void openConversation() {
        this.updateActionBarTitle(true);
            ...
            public void onPresenceSelected() {
                ...
                switch (attachmentChoice) {
                    ...
                    case ATTACHMENT_CHOICE_RECORD_VOICE:
                        ...
                        fallbackPackageId = "com.iblue.conversations.voicerecorder";
                        break;
                    case ATTACHMENT_CHOICE_LOCATION:
                        intent.setAction("com.iblue.conversations.location.request");
                        fallbackPackageId = "com.iblue.conversations.sharelocation";
                        break;
                }
    ...
    protected void attachFileDialog() {
        ...
        if (new Intent("com.iblue.conversations.location.request").resolveActivity(getPackageManager()) == null) {
