...
import com.iblue.chat.entities.ListItem;
import com.iblue.chat.entities.Presences;
import com.iblue.chat.services.XmppConnectionService.OnRosterUpdate;
import com.iblue.chat.ui.adapter.KnownHostsAdapter;
import com.iblue.chat.ui.adapter.ListItemAdapter;
import com.iblue.chat.utils.XmppUri;
...
public class StartConversationActivity extends XmppActivity implements OnRosterUpdate, OnUpdateBlocklist {
	...
	//	mContactsTab.setCustomView(R.layout.tab);
		mConferencesTab = actionBar.newTab().setText(R.string.conferences)
			.setTabListener(mTabListener);
	//	mConferencesTab.setCustomView(R.layout.tab);
